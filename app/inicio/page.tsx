...
export default function DashboardAlumno() {
  ...
  return (
    <div
      style={{ background: NM.bg, fontFamily: "var(--font-heading)", color: NM.text, minHeight: '100%' }}
    >
      <OfflineBanner />
      {/* Contenido central: el layout ya aporta UN Sidebar (izq) y RightRail (der) en /inicio */}
      <main
